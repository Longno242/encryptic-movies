...
function BackupRestoreSection({ onRestored }) {
  ...
  const handleExport = () => {
    ...
    a.href = url;
    a.download = `mov-backup-${new Date().toISOString().slice(0, 10)}.json`;
    a.click();
...
function AppearanceSection() {
  const [accent, setAccent] = useState(
    () => storage.get(STORAGE_KEYS.ACCENT_COLOR) || "encryptic",
  );
...
function StartPageSection() {
  ...
  return (
    <div style={{ marginBottom: 40 }}>
      ...
      >
        Choose which page opens when you launch Encryptic Movies.
      </div>
      <div
        style={{
          display: "flex",
    ...
    <>
      ...
      {showDeleteDlConfirm && (
        <ConfirmDialog
          ...
          description="This will permanently delete all video files downloaded through Encryptic Movies and remove them from the download list."
      ...
      {showRemoveKeyConfirm && (
        <ConfirmDialog
          ...
          description="Your TMDB token will be deleted from secure storage on this device. You will return to the setup screen to sign in again or skip."
          confirmLabel="Remove & sign out"
          onConfirm={async () => {
            setShowRemoveKeyConfirm(false);
            if (onRemoveApiKey) await onRemoveApiKey();
          }}
      ...
      >
        ...
        <div style={{ color: "var(--text3)", fontSize: 14, marginBottom: 48 }}>
          App configuration for Encryptic Movies
        </div>
        ...
        <div ref={secDownloads} style={{ scrollMarginTop: 80 }}>
          ...
          <div style={{ marginBottom: 40 }}>
            ...
            >
              ...
              and Encryptic Movies has write access to it.
            </div>
            <div
              style={{
                display: "flex",
            ...
            >
              <input
                className="apikey-input"
                style={{ flex: 1, minWidth: 260, marginBottom: 0 }}
                placeholder="Desktop\MOVIES (default)"
                value={downloadPath}
            ...
            <div style={{ marginTop: 10, fontSize: 13, color: "var(--text2)" }}>
              Default: <code>Desktop\MOVIES</code> (created automatically when you
              download).
            </div>
          </div>
        </div>
          ...
          >
            ...
            <div style={{ padding: "22px 24px" }}>
              <CleanRow
                ...
                description="Opens the folder where Encryptic Movies is installed."
            ...
            <div style={{ padding: "22px 24px" }}>
              <CleanRow
                title="Delete All Downloads"
                description="Permanently deletes all video files that were downloaded through Encryptic Movies and removes them from the download list. Only files downloaded through the app will be deleted, nothing else in your folder is touched."
            ...
            >
              ...
              >
                <div style={{ flex: 1 }}>
                  ...
                  >
                    Completely resets Encryptic Movies to factory defaults, clears all
