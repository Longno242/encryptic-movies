...
export const KNOWN_ISSUES = [
  ...
  },
  {
    ...
    title: "In-app update stuck on old version after install",
    summary:
      "Windows in-app updates replace the whole install folder with the new portable build (not just the .exe), so the version number actually bumps. Watch history and library stay in AppData. Updates to v1.0.11+ clear your saved TMDB key once so you choose free catalog or enter a key again.",
    tryThese: [
      "Use Download & install in the update prompt (portable build, not Setup).",
      "If you used the Setup installer before, one in-app update fixes the folder layout.",
  ...
  },
  {
    ...
    severity: "info",
    status: "Fixed in v1.0.12",
    title: "After update: must choose free catalog or TMDB key",
    summary:
      "Upgrading from an older build shows “How do you want to browse?” on every launch until you pick Continue without API key or Continue with TMDB API key. Your watch history and settings are kept.",
    tryThese: [
      "Pick free catalog for TV and anime without a key, or enter a new TMDB token for full movies.",
      "Settings → Change catalog mode later without losing your library.",
    ],
  },
  {
