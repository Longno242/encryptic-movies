/** Preload for the picture-in-picture pop-out window. */
...
function injectTitlebar() {
  if (document.getElementById("__mov_titlebar__")) return;

  // -- Bar -------------------------------------------------------------------
  const bar = document.createElement("div");
  bar.id = "__mov_titlebar__";
  css(bar, {
    position: "fixed",
    top: "0",
    left: "0",
  ...
  label.textContent = "Encryptic Movies";
